...
DATA_FILENAME = '../data/60000_hands_sample_details.csv' # 60k triple draw hands... best draw output only

MAX_INPUT_SIZE = 50000 # Remove this constraint, as needed
...
def load_data():
    data = _load_poker_csv(filename=DATA_FILENAME, keep_all_data=True)
